...
\kesifcevap{GLM: $g(E[Y])=\mathbf{x}^\top\boldsymbol\beta$ (bağlantı fonksiyonu $g$).
  Lojistik regresyon: $g=\mathrm{logit}$, $Y\sim\mathrm{Bernoulli}$.
  Poisson regresyon: $g=\log$, $Y\sim\mathrm{Poisson}$.
  Üstel aile üyeleri olduğu için MLE'ye IRLS (yinelemeli ağırlıklı EKK) uygulanır.}
\end{kesif}
