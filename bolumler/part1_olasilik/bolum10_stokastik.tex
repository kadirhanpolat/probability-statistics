...
\medskip
\noindent\textbf{Köprü:} Bölüm~\ref{chp:martingaller}'daki filtrasyon ve uyum kavramları doğrudan burada kullanılacak. Markov zincirlerindeki geçişler aslında σ-cebirlerinin monoton dizisi anlamında "bilgi artışı" kavramıdır.
\end{motivasyon}
