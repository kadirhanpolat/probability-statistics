...
(a) $\mathbb{Q}$ (rasyonel sayılar) sayılabilir olduğunu gösterin.
(b) $[0,1]$'in sayılamaz sonsuz olduğunu Cantor'un diyagonal argümanıyla gösterin.
...
$f:[0,1]\to\mathbb{R}$ sürekli. (a) $f$'nin $[0,1]$'de üniform sürekli olduğunu Heine-Cantor teoremi ile açıklayın. (b) Weierstrass yaklaşım teoremini ifade edin ve $f(x)=|x-1/2|$ için sezgisel uygulayın. (c) $g:(0,1)\to\mathbb{R}$, $g(x)=1/x$ sürekli ama üniform sürekli değil --- kanıtlayın.
\end{alistirma}
\alcozum{%
...
(a) Cauchy kriterini kullanarak $(a_n)$'nin yakınsadığını gösterin.
(b) Bu serinin limitinin $\ln 2$ olduğunu biliyorsunuz. Limiti kullanmadan yakınsama göstermenin avantajını tartışın.
\end{alistirma}
\alcozum{%
...
(a) Nokta limit $f(x) = \lim_{n\to\infty} f_n(x)$'i bulun.
(b) Yakınsama düzgün mü? $\sup_{x\in\mathbb{R}}|f_n(x) - f(x)|$'i hesaplayın.
...
$a_n = n^{1/n}$ ($n \geq 1$).
(a) $n \geq 3$ için $a_n$ azalan olduğunu gösterin ($a_n > a_{n+1}$).
(b) $a_n \geq 1$ olduğunu gösterin.
(c) Sıkıştırma veya monoton dizi teoremiyle $a_n \to 1$ olduğunu gösterin.
\end{alistirma}
\alcozum{%
